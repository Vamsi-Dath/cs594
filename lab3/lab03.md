...
1. Use SSH to create a tunnel to the Kafka server (enter the password for your NetID after issuing the following command):  
   `ssh -o ServerAliveInterval=60 -L 9092:localhost:9092 NetID@cs594.cs.uic.edu -NTf`
